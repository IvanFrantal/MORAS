...
# -----------------  
            ...
            if str.isdigit(l[2]) == False:
                print("Parser, " + l[2] + ", argument in push is not a non-negative number")
                return ""
...
# -----------------  
            ...
            if str.isdigit(l[2]) == False:
                print("Parser, " + l[2] + ", argument in pop is not a non-negative number")
                return ""
...
# -----------------                
                ...
                self._labelsExist.append(l[1])
                return "//" + " ".join(l) + "\n" + self._label(l[1], n)
            elif l[0] == "goto" and len(l) == 2:
                self._labelsChkExist.append(l[1])
                self._lineNum.append(n+1)
                return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
...
# -------------        
        ...
        for label in self._labelsChkExist:
            cntlabs += 1
            if label not in self._labelsExist:
                print("Error: non-existent label found -> (" + label + ") at line: " + str(self._lineNum[cntlabs]))
                return ""
